 ...
 */
public class ProjectPictureActivity extends AppCompatActivity {
...
//        }else {
            ...
            toolBarIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i = new Intent(ProjectPictureActivity.this, HomeActivity.class);
...
//        }
        ...
        if(language.equals("FA")){
            title.setText(R.string.project_FA);
        }
